...
class ResNet(nn.Module):
    ...
    Args:
        ...
        norm_cfg (dict): dictionary to construct and old_configs norm layer.
    ...
    def __init__(self,
        ...
        assert num_stages >= 1 and num_stages <= 4, 'Error: num_stages out of range [1, 4].'
    ...
    def _make_stem_layer(self, in_channels):
        self.conv1 = build_conv_layer(in_channels,
                                      64,
                                      kernel_size=7,
                                      stride=2,
                                      padding=3,
    ...
    def init_weights(self, pretrained=None):
        if isinstance(pretrained, str):
            load_state_dict(self, torch.load(pretrained), strict=False)
